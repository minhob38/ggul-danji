...
from package.currency import calculate_reference_exchange_rate
...
# 매수해야할 기준 환율 계산
calculate_reference_exchange_rate(range=365, nation="USA")
calculate_reference_exchange_rate(range=365, nation="JAPAN")
